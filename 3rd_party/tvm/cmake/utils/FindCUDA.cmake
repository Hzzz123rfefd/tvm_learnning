...
#
# Usage:
#   find_cuda(${USE_CUDA} ${USE_CUDNN} ${USE_CUDA_TARGET})
#
...
# - CUDA_CUBLAS_LIBRARY
#
macro(find_cuda use_cuda use_cudnn use_cuda_target)
  set(__use_cuda ${use_cuda})
  if(${__use_cuda} MATCHES ${IS_TRUE_PATTERN})
    message(WARNING "Finding CUDA with auto search, ignoring USE_CUDA_TARGET=${use_cuda_target}")
  ...
  elseif(IS_DIRECTORY ${__use_cuda})
    ...
    message(STATUS "Use CUDA_TARGET=" ${use_cuda_target})
  ...
  if(CUDA_FOUND)
    if(MSVC)
      ...
      set(CUDA_FINDLIB_SUFFIXES lib lib64 targets/${use_cuda_target}/lib targets/${use_cuda_target}/lib/stubs lib64/stubs lib/${use_cuda_target}-gnu)
      find_library(_CUDA_CUDA_LIBRARY cuda
        PATHS ${CUDA_TOOLKIT_ROOT_DIR}
        PATH_SUFFIXES ${CUDA_FINDLIB_SUFFIXES}
        NO_DEFAULT_PATH)
